        ...
        <div className="min-h-screen flex items-center justify-center p-4">
          <div className="backdrop-blur-xl bg-white/10 rounded-3xl shadow-2xl p-6 sm:p-8 w-full max-w-md border border-white/20">
            <div className="text-center mb-6 sm:mb-8">
              ...
              <h1 className="text-xl sm:text-2xl font-semibold text-white">Сброс пароля</h1>
              <p className="text-white/70 text-xs sm:text-sm mt-1">Введите email для восстановления</p>
            </div>
            ...
            <form onSubmit={handleForgotPassword} className="space-y-4 sm:space-y-5">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-lg focus:ring-2 focus:ring-white/50 focus:border-white/50 outline-none transition text-white placeholder-white/50 text-base"
              ...
              <button
                ...
                className="w-full bg-white/20 text-white py-3 rounded-lg hover:bg-white/30 transition disabled:opacity-50 font-medium text-base"
              >
                {resetLoading ? (
        ...
        <div className="backdrop-blur-xl bg-white/10 rounded-3xl shadow-2xl p-6 sm:p-8 w-full max-w-md border border-white/20">
          <div className="text-center mb-6 sm:mb-8">
            <img 
              ...
              alt="Hotel Assistant" 
              className="w-16 h-16 sm:w-20 sm:h-20 mx-auto mb-4 drop-shadow-lg"
            />
            <h1 className="text-xl sm:text-2xl font-bold text-white">Hotel Assistant</h1>
            <p className="text-white/70 text-xs sm:text-sm mt-1">Вход в систему</p>
          </div>
